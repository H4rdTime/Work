...
export function middleware(request: NextRequest) {
  ...
  const cspDirectives = [
    ...
    `script-src 'self' 'nonce-${nonce}' 'unsafe-eval' 'unsafe-inline' https://*.supabase.co https://www.googletagmanager.com https://www.google-analytics.com https://mc.yandex.ru https://yastatic.net https://api-maps.yandex.ru`,
