...
// Указываем, что параметры не динамические (статическая генерация)
...
export async function generateMetadata({
    ...
    const { category } = await params; // Await the params Promise first
    return {
...
export default async function CategoryPage({
    ...
    const { data: categoryData } = await supabase
        ...
        .single();
    console.log('Category data from Supabase:', categoryData); // Отладка
    console.log('Category from URL:', decodedCategory);
    console.log('Category data from Supabase:', categoryData);
