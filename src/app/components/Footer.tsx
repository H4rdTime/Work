            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-4">
                  <a href="tel:+78142270545" className="text-gray-600 hover:text-[#218CE9]" suppressHydrationWarning>+7 (8142) 27-05-45</a>
                  <a href="tel:+78142330090" className="text-gray-600 hover:text-[#218CE9]" suppressHydrationWarning>+7 (8142) 33-00-90</a>
                </div>
              </div>
