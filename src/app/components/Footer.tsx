...
const Footer = () => {
  return (
    <footer className="container min-w-[390px] mx-auto px-4 py-8">

        <div className="border-b border-black border-opacity-10 mb-8"></div>
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 max-w-md mx-auto bg-[#F5F5F5] rounded-xl p-6 shadow-lg">
          {/* Колонка "Компания" */}
